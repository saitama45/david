...
class SidebarMenuSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['menu_key' => 'reports.adoption-rate-tracking',       'parent_key' => 'reports', 'sort_order' => 8],
            ['menu_key' => 'reports.top-10-inventories',           'parent_key' => 'reports', 'sort_order' => 9],
            ['menu_key' => 'reports.days-inventory-outstanding',   'parent_key' => 'reports', 'sort_order' => 10],
            ['menu_key' => 'reports.days-payable-outstanding',     'parent_key' => 'reports', 'sort_order' => 11],
            ['menu_key' => 'reports.sales',                        'parent_key' => 'reports', 'sort_order' => 12],
            ['menu_key' => 'reports.inventories',                  'parent_key' => 'reports', 'sort_order' => 13],
            ['menu_key' => 'reports.upcoming-inventories',         'parent_key' => 'reports', 'sort_order' => 14],
            ['menu_key' => 'reports.account-payable',              'parent_key' => 'reports', 'sort_order' => 15],
            ['menu_key' => 'reports.cost-of-goods',                'parent_key' => 'reports', 'sort_order' => 16],
            ['menu_key' => 'reports.item-orders-summary',          'parent_key' => 'reports', 'sort_order' => 17],
            ['menu_key' => 'reports.ice-cream-orders',             'parent_key' => 'reports', 'sort_order' => 18],
            ['menu_key' => 'reports.salmon-orders',                'parent_key' => 'reports', 'sort_order' => 19],
            ['menu_key' => 'reports.fruits-and-vegetables',        'parent_key' => 'reports', 'sort_order' => 20],
