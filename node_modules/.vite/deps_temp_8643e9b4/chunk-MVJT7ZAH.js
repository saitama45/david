...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  return r === "class" || r === "attr" ? C2(s2(t2) ? `${e}${t2},${e} ${t2}` : e, s4) : C2(e, C2(t2 != null ? t2 : ":root,:host", s4));
}, transformCSS(e, t2, r, s4, i2 = {}, a2, n, l2) {
  if (s2(t2)) {
    let { cssLayer: o } = i2;
    if (s4 !== "style") {
      let c3 = this.getColorSchemeOption(i2, n);
      t2 = r === "dark" ? c3.reduce((m2, { type: d2, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d2, t2)), m2), "") : C2(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
      let c3 = { name: "primeui", order: "primeui" };
      i(o) && (c3.name = m(o.name, { name: e, type: s4 })), s2(c3.name) && (t2 = C2(`@layer ${c3.name}`, t2), a2 == null || a2.layerNames(c3.name));
    }
    return t2;
  }
  return "";
...
//# sourceMappingURL=chunk-MVJT7ZAH.js.map
