...
function b2(e, t, n = /* @__PURE__ */ new WeakSet()) {
  ...
  n.add(e).add(t);
  let o = Array.isArray(e), r = Array.isArray(t), u, f2, T;
  if (o && r) {
    if (f2 = e.length, f2 != t.length) return false;
    for (u = f2; u-- !== 0; ) if (!b2(e[u], t[u], n)) return false;
    return true;
  }
  if (o != r) return false;
  ...
  if (f2 = R2.length, f2 !== Object.keys(t).length) return false;
  for (u = f2; u-- !== 0; ) if (!Object.prototype.hasOwnProperty.call(t, R2[u])) return false;
  for (u = f2; u-- !== 0; ) if (T = R2[u], !b2(e[T], t[T], n)) return false;
  return true;
}
function y2(e, t) {
  return b2(e, t);
...
//# sourceMappingURL=chunk-KIEPSW4Z.js.map
