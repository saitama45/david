...
import {
  script as script2
} from "./chunk-MW42IEQX.js";
import "./chunk-NTY2BRAY.js";
import {
  Ripple
} from "./chunk-LKDDBXYF.js";
import {
  script
} from "./chunk-T2R5HHB4.js";
import {
  D,
  Ht,
  I,
  ...
  methods: {
    ...
    selectDate: function selectDate(dateMeta) {
      ...
      if (this.isSingleSelection()) {
        ...
        modelVal = this.rawValue ? [].concat(_toConsumableArray5(this.rawValue), [date]) : [date];
      } else if (this.isRangeSelection()) {
    ...
    updateModelTime: function updateModelTime() {
      ...
      if (this.isMultipleSelection()) {
        value = [].concat(_toConsumableArray5(this.rawValue.slice(0, -1)), [value]);
      }
    ...
    createResponsiveStyle: function createResponsiveStyle() {
      if (this.numberOfMonths > 1 && this.responsiveOptions && !this.isUnstyled) {
        ...
        if (this.responsiveOptions) {
          var comparer = W();
          var responsiveOptions2 = _toConsumableArray5(this.responsiveOptions).filter(function(o) {
