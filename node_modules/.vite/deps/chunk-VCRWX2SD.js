...
var le = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: o, options: a2 } = g3.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, i2 = z(t2, v2) ? t2 : `{${t2}}`;
...
function ce(e, t2 = {}) {
  ...
  for (; i2.length; ) {
    ...
    for (let p2 in m2) {
      let h = m2[p2], y3 = ke(h), x2 = z(p2, a2) ? Q(u) : Q(u, ee(p2));
...
//# sourceMappingURL=chunk-VCRWX2SD.js.map
