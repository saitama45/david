import {
  ...
  size,
  useFloating
} from "./chunk-WHM2DWC5.js";
import {
  vue_runtime_esm_bundler_exports
} from "./chunk-PCAMPU7B.js";
import {
  Comment,
  Fragment,
  Teleport,
  ...
  withMemo,
  withModifiers
} from "./chunk-KQ2G7SGN.js";
import {
  __privateAdd,
  __privateGet
} from "./chunk-BVUA3U46.js";
...
function useId2(deterministicId, prefix = "reka") {
  ...
  if (Object.hasOwn(vue_runtime_esm_bundler_exports, "useId")) {
    return `${prefix}-${(_a = useId) == null ? void 0 : _a()}`;
...
var _sfc_main13 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main12), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main14), {
        ...
        default: withCtx(() => [
          createVNode(unref(_sfc_main15), mergeProps({
            id: unref(rootContext).contentId,
            ref: unref(forwardRef),
            as: _ctx.as,
            "as-child": _ctx.asChild,
...
var _sfc_main17 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main16, mergeProps({ ...props2, ...unref(emitsAsProps) }, {
        ref: unref(forwardRef),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          unref(rootContext).modal.value ? (openBlock(), createBlock(_sfc_main17, mergeProps({
            key: 0,
            ref: unref(forwardRef)
            ...
            _: 3
          }, 16)) : (openBlock(), createBlock(_sfc_main18, mergeProps({
            key: 1,
            ref: unref(forwardRef)
          }, { ...props2, ...unref(emitsAsProps), ..._ctx.$attrs }), {
            default: withCtx(() => [
...
var _sfc_main20 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main19), mergeProps({ ...props2, ...unref(emitsAsProps) }, {
        role: "alertdialog",
...
var _sfc_main21 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main12), mergeProps(props2, { ref: unref(forwardRef) }), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main23 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main22), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main31 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main30), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main33 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main32), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin } = {}) {
  ...
  onMounted(() => {
    ...
    watchEffect((onCleanup) => {
      ...
      if (referrerPolicy == null ? void 0 : referrerPolicy.value)
        img.referrerPolicy = referrerPolicy.value;
      if (typeof (crossOrigin == null ? void 0 : crossOrigin.value) === "string")
...
function useDateFormatter(initialLocale, opts = {}) {
  ...
  function custom(date, options) {
    return new $fb18d541ea1ad717$export$ad991b66133851cf(locale.value, { ...opts, ...options }).format(date);
  }
  ...
  function fullMonthAndYear(date, options = {}) {
    return new $fb18d541ea1ad717$export$ad991b66133851cf(locale.value, { ...opts, month: "long", year: "numeric", ...options }).format(date);
  }
  function fullMonth(date, options = {}) {
    return new $fb18d541ea1ad717$export$ad991b66133851cf(locale.value, { ...opts, month: "long", ...options }).format(date);
  }
  function getMonths() {
  ...
  function fullYear(date, options = {}) {
    return new $fb18d541ea1ad717$export$ad991b66133851cf(locale.value, { ...opts, year: "numeric", ...options }).format(date);
  }
  function toParts(date, options) {
    if (isZonedDateTime(date)) {
      ...
      return new $fb18d541ea1ad717$export$ad991b66133851cf(locale.value, { ...opts, ...options }).formatToParts(toDate(date));
    }
  }
  function dayOfWeek(date, length = "narrow") {
    return new $fb18d541ea1ad717$export$ad991b66133851cf(locale.value, { ...opts, weekday: length }).format(date);
  }
...
var _sfc_main52 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return isFormArrayEmptyAndRequired.value ? (openBlock(), createBlock(_sfc_main51, mergeProps({ key: _ctx.name }, { ...props2, ..._ctx.$attrs }, {
        name: _ctx.name,
        value: _ctx.value
  ...
  setup(__props, { emit: __emit }) {
    ...
    const computedMiddleware = computedEager(() => {
      return [
        ...
        props2.prioritizePosition && props2.avoidCollisions && flip({
          ...detectOverflowOptions.value
        }),
        props2.avoidCollisions && shift({
          mainAxis: true,
          crossAxis: !!props2.prioritizePosition,
          limiter: props2.sticky === "partial" ? limitShift() : void 0,
          ...detectOverflowOptions.value
        }),
        !props2.prioritizePosition && props2.avoidCollisions && flip({
          ...detectOverflowOptions.value
        ...
        arrow$1.value && arrow({ element: arrow$1.value, padding: props2.arrowPadding }),
        transformOrigin({
          arrowWidth: arrowWidth.value,
          arrowHeight: arrowHeight.value
        }),
        props2.hideWhenDetached && hide({ strategy: "referenceHidden", ...detectOverflowOptions.value })
      ];
    });
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("span", {
        ...
        createVNode(_sfc_main60, mergeProps(_ctx.$attrs, {
          ref: unref(forwardRef),
          style: {
            display: "block"
          },
...
var _sfc_main64 = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const filterState = computed((oldValue) => {
      if (!filterSearch.value || props2.ignoreFilter || isVirtual.value) {
        return {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main57), null, {
        default: withCtx(() => [
          createVNode(unref(_sfc_main63), mergeProps({
            ref_key: "primitiveElement",
            ref: primitiveElement
          }, _ctx.$attrs, {
            modelValue: unref(modelValue),
...
var _sfc_main66 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main65), { "as-child": "" }, {
        default: withCtx(() => [
          createVNode(unref(_sfc_main15), {
            "as-child": "",
            "disable-outside-pointer-events": _ctx.disableOutsidePointerEvents,
            onDismiss: _cache[0] || (_cache[0] = ($event) => unref(rootContext).onOpenChange(false)),
            ...
            default: withCtx(() => [
              (openBlock(), createBlock(resolveDynamicComponent(unref(position) === "popper" ? unref(_sfc_main61) : unref(Primitive)), mergeProps({ ..._ctx.$attrs, ...unref(forwardedProps) }, {
                id: unref(rootContext).contentId,
                ref: unref(forwardRef),
                "data-state": unref(rootContext).open.value ? "open" : "closed",
                style: {
...
var _sfc_main67 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return unref(rootContext).open.value && unref(contentContext).position.value === "popper" ? (openBlock(), createBlock(unref(_sfc_main62), normalizeProps(mergeProps({ key: 0 }, props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main66, mergeProps({ ...unref(forwarded), ..._ctx.$attrs }, { ref: unref(forwardRef) }), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main72 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main71), mergeProps({
        id: unref(id),
...
var _sfc_main74 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main73), {
        ref_key: "primitiveElement",
        ref: primitiveElement,
        modelValue: unref(modelValue),
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isRef(modelValue) ? modelValue.value = $event : null),
...
var _sfc_main76 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return isRender.value ? (openBlock(), createBlock(unref(_sfc_main75), mergeProps({ key: 0 }, props2, {
        id: unref(id),
        ref_key: "primitiveElement",
        ref: primitiveElement,
...
var _sfc_main78 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main77), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main85 = defineComponent({
  ...
  setup(__props) {
    ...
    rootContext.isVirtual.value = true;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main84, normalizeProps(guardReactiveProps(props2)), {
        default: withCtx((slotProps) => [
          renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(slotProps)))
        ]),
        _: 3
...
var _sfc_main87 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main86), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main91 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main90, mergeProps(props2, {
        ref: unref(forwardRef),
...
var _sfc_main93 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main91, mergeProps({ role: "menuitemcheckbox" }, props2, {
...
var _sfc_main94 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main93), normalizeProps(guardReactiveProps({ ...props2, ...unref(emitsAsProps) })), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main95 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useHideOthers(currentElement);
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main89, mergeProps(unref(forwarded), {
        ref: unref(forwardRef),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          unref(rootContext).modal.value ? (openBlock(), createBlock(_sfc_main95, normalizeProps(mergeProps({ key: 0 }, { ..._ctx.$attrs, ...unref(forwarded) })), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
          }, 16)) : (openBlock(), createBlock(_sfc_main96, normalizeProps(mergeProps({ key: 1 }, { ..._ctx.$attrs, ...unref(forwarded) })), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main98 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main88), {
        open: open.value,
...
var _sfc_main99 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main97), mergeProps(unref(forwarded), {
        side: "right",
        "side-offset": 2,
        align: "start",
...
var _sfc_main101 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main100), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main102 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main91), normalizeProps(guardReactiveProps({ ...props2, ...unref(emitsAsProps) })), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main103 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main92), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main108 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main100, normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default", { modelValue: unref(modelValue) })
        ]),
        _: 3
...
var _sfc_main109 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main108), normalizeProps(guardReactiveProps({ ...props2, ...unref(emitsAsProps) })), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main110 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    provideMenuItemIndicatorContext({ modelValue });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main91, mergeProps({ role: "menuitemradio" }, props2, {
...
var _sfc_main111 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main110), normalizeProps(guardReactiveProps({ ...props2, ...unref(emitsAsProps) })), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main113 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main112), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main115 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main114), {
        open: unref(open),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main89, mergeProps(unref(forwarded), {
...
var _sfc_main117 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main116), mergeProps(unref(forwarded), { style: {
        "--reka-context-menu-content-transform-origin": "var(--reka-popper-transform-origin)",
        "--reka-context-menu-content-available-width": "var(--reka-popper-available-width)",
        "--reka-context-menu-content-available-height": "var(--reka-popper-available-height)",
        "--reka-context-menu-trigger-width": "var(--reka-popper-anchor-width)",
...
var _sfc_main118 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main58), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main119 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main118, { "as-child": "" }, {
        default: withCtx(() => [
          createVNode(_sfc_main90, mergeProps(props2, {
...
var _sfc_main120 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main119), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main121 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(unref(_sfc_main118), {
          as: "template",
...
function createContentObj(props2) {
  ...
  function getPartContent(part) {
    if ("hour" in segmentValues) {
      ...
      if (value !== null) {
        if (part === "day") {
          return formatter.part(props2.dateRef.set({
            [part]: value,
            /**
             * Edge case for the day field:
             *
        ...
        return formatter.part(props2.dateRef.set({ [part]: value }), part, {
          hourCycle: normalizeHourCycle(props2.hourCycle)
        });
      } else {
...
var _sfc_main127 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main126), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main133 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main132), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
      ...
      return openBlock(), createBlock(unref(_sfc_main14), {
        ...
        default: withCtx(() => [
          createVNode(unref(_sfc_main15), {
            ...
            default: withCtx(() => [
              createVNode(unref(_sfc_main61), mergeProps(unref(forwarded), {
                id: unref(rootContext).contentId,
                ref: unref(forwardRef),
                "data-state": unref(rootContext).open.value ? "open" : "closed",
...
var _sfc_main136 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useHideOthers(currentElement);
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main135, mergeProps(unref(forwarded), {
        ref: unref(forwardRef),
        "trap-focus": unref(rootContext).open.value,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          unref(rootContext).modal.value ? (openBlock(), createBlock(_sfc_main136, mergeProps({ key: 0 }, unref(forwarded), { ref: unref(forwardRef) }), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
          }, 16)) : (openBlock(), createBlock(_sfc_main137, mergeProps({ key: 1 }, unref(forwarded), { ref: unref(forwardRef) }), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main139 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main134), normalizeProps(guardReactiveProps(_ctx.portal)), {
        default: withCtx(() => [
          createVNode(unref(_sfc_main138), normalizeProps(guardReactiveProps({ ...unref(forwarded), ..._ctx.$attrs })), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main151 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(rootContext).hasCustomAnchor.value ? unref(Primitive) : unref(_sfc_main58)), { "as-child": "" }, {
        default: withCtx(() => [
          createVNode(unref(Primitive), {
...
var _sfc_main152 = defineComponent({
  ...
  setup(__props) {
    ...
    const rootContext = injectDatePickerRootContext();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main151), mergeProps({ "data-reka-date-field-segment": "trigger" }, props2, {
        disabled: unref(rootContext).disabled.value,
...
var _sfc_main153 = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    watch(modelValue, (_modelValue) => {
      ...
      if (isStartChanged) {
        startValue.value = (_a2 = _modelValue == null ? void 0 : _modelValue.start) == null ? void 0 : _a2.copy();
      }
      ...
      if (isEndChanged) {
        endValue.value = (_b2 = _modelValue == null ? void 0 : _modelValue.end) == null ? void 0 : _b2.copy();
      }
    });
...
var _sfc_main155 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main125), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
function useRangeCalendarState(props2) {
  ...
  const rangeIsDateDisabled = (date) => {
    ...
    if (!props2.start.value || props2.end.value || $14e0f24ef4ac5c92$export$ea39ec197993aef0(props2.start.value, date))
      return false;
    return false;
  };
  const isDateHighlightable = (date) => {
    var _a;
    if ((_a = props2.isDateHighlightable) == null ? void 0 : _a.call(props2, date))
      return true;
    return false;
  };
  const highlightedRange = computed(() => {
    var _a;
    if (props2.start.value && props2.end.value && !props2.fixedDate.value)
      return null;
...
var _sfc_main158 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    watch(modelValue, (_modelValue, _prevValue) => {
      var _a, _b, _c, _d;
      if (!(_prevValue == null ? void 0 : _prevValue.start) && (_modelValue == null ? void 0 : _modelValue.start) || !_modelValue || !_modelValue.start || startValue.value && !$14e0f24ef4ac5c92$export$91b62ebf2ba703ee(_modelValue.start, startValue.value)) {
        startValue.value = (_b = (_a = _modelValue == null ? void 0 : _modelValue.start) == null ? void 0 : _a.copy) == null ? void 0 : _b.call(_a);
      }
      if (!(_prevValue == null ? void 0 : _prevValue.end) && _modelValue.end || !_modelValue || !_modelValue.end || endValue.value && !$14e0f24ef4ac5c92$export$91b62ebf2ba703ee(_modelValue.end, endValue.value)) {
...
var _sfc_main159 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a;
      return openBlock(), createBlock(unref(_sfc_main158), mergeProps({
...
var _sfc_main161 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main160), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main162 = defineComponent({
  ...
  setup(__props) {
    ...
    function handleFocus() {
      var _a;
      if (isDisabled.value || ((_a = rootContext.isDateUnavailable) == null ? void 0 : _a.call(rootContext, props2.day)))
        return;
...
var _sfc_main163 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main162), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx((slotProps) => [
          renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(slotProps)))
        ]),
        _: 3
...
var _sfc_main166 = defineComponent({
  ...
  setup(__props) {
    const rootContext = injectDateRangePickerRootContext();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main153), mergeProps({
        ref: unref(rootContext).dateFieldRef,
        "model-value": unref(rootContext).modelValue.value,
        placeholder: unref(rootContext).placeholder.value
      }, {
...
var _sfc_main178 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main177), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main180 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main179), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx(({ headingValue }) => [
          renderSlot(_ctx.$slots, "default", { headingValue }, () => [
            createTextVNode(toDisplayString(headingValue), 1)
          ])
...
var _sfc_main183 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main182), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx((slotProps) => [
          renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(slotProps)))
        ]),
        _: 3
...
var _sfc_main185 = defineComponent({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main184), normalizeProps(guardReactiveProps(props2)), {
        default: withCtx((slotProps) => [
          renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(slotProps)))
        ]),
        _: 3
...
var _sfc_main198 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main110), normalizeProps(guardReactiveProps(unref(forwarded))), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main203 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main118), { "as-child": "" }, {
        default: withCtx(() => [
          createVNode(unref(Primitive), {
            id: unref(rootContext).triggerId,
            ref: unref(forwardRef),
...
var _sfc_main213 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main15), {
        "as-child": "",
        "disable-outside-pointer-events": false,
        onEscapeKeyDown: _cache[1] || (_cache[1] = ($event) => emits("escapeKeyDown", $event)),
        ...
        default: withCtx(() => [
          createVNode(unref(_sfc_main61), mergeProps({ ...unref(forwarded), ..._ctx.$attrs }, {
            ref: unref(forwardRef),
            "data-state": unref(rootContext).open.value ? "open" : "closed",
            style: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main213, mergeProps(unref(forwarded), {
            ref: unref(forwardRef),
...
var _sfc_main233 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main116), mergeProps(unref(forwarded), {
        "data-reka-menubar-content": "",
        style: {
          "--reka-menubar-content-transform-origin": "var(--reka-popper-transform-origin)",
          "--reka-menubar-content-available-width": "var(--reka-popper-available-width)",
...
var _sfc_main234 = defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main119), mergeProps(props2, { "data-reka-menubar-subtrigger": "" }), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
      ...
      return openBlock(), createBlock(unref(_sfc_main54), {
        ...
        default: withCtx(() => [
          createVNode(unref(CollectionItem), null, {
            default: withCtx(() => [
              createVNode(unref(_sfc_main118), { "as-child": "" }, {
                default: withCtx(() => [
                  createVNode(unref(Primitive), {
...
var _sfc_main238 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main15), mergeProps({
        id: unref(contentId),
        ref: unref(forwardRef),
          ...
          return [
            createVNode(unref(Primitive), mergeProps(_ctx.$attrs, {
              ...
              style: {
                ...
                pointerEvents: !open.value && unref(menuContext).isRootMenu ? "none" : void 0,
                ["--reka-navigation-menu-viewport-width"]: size2.value ? `${(_a2 = size2.value) == null ? void 0 : _a2.width}px` : void 0,
                ["--reka-navigation-menu-viewport-height"]: size2.value ? `${(_b = size2.value) == null ? void 0 : _b.height}px` : void 0,
...
function clamp2(value, min = Number.NEGATIVE_INFINITY, max = Number.POSITIVE_INFINITY) {
...
var _sfc_main246 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props2 = __props;
    const emits = __emit;
    const { disabled, disableWheelChange, invertWheelChange, min, max, step, stepSnapping, formatOptions, id, locale: propLocale } = toRefs(props2);
    const modelValue = useVModel(props2, "modelValue", emits, {
      defaultValue: props2.defaultValue,
      passive: props2.modelValue === void 0
    });
    ...
    function clampInputValue(val) {
      ...
      if (step.value === void 0 || isNaN(step.value) || !stepSnapping.value)
        clampedValue = clamp2(val, min.value, max.value);
      else
  ...
  setup(__props) {
    ...
    function handleMultipleCharacter(values) {
      ...
      for (let i = initialIndex; i < lastIndex; i++) {
        ...
        if (context2.isNumericMode.value && !/^\d*$/.test(value))
          continue;
...
var _sfc_main260 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const max = useVModel(props2, "max", emit, {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(Primitive), {
        ...
        "aria-valuetext": (_a = _ctx.getValueText) == null ? void 0 : _a.call(_ctx, unref(modelValue), unref(max)),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main54), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main262, mergeProps({ ..._ctx.$attrs, ...props2 }, {
            ref: unref(forwardRef),
            checked: checked.value,
...
var _sfc_main268 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return hasCorner.value ? (openBlock(), createBlock(_sfc_main267, mergeProps({ key: 0 }, props2, { ref: unref(forwardRef) }), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
function getThumbOffsetFromScroll(scrollPos, sizes, dir = "ltr") {
  ...
  const scrollWithoutMomentum = clamp2(
    scrollPos,
    scrollClampRange[0],
    scrollClampRange[1]
  );
...
var _sfc_main270 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main269, {
        ref: unref(forwardRef),
        "is-horizontal": true,
...
var _sfc_main272 = defineComponent({
  ...
  setup(__props) {
    ...
    function onThumbPositionChange() {
      if (isShowingScrollbarX.value) {
        if (rootContext.viewport.value && thumbRef.value) {
          ...
          thumbRef.value.style.transform = `translate3d(${offset2}px, 0, 0)`;
        }
      } else {
        if (rootContext.viewport.value && thumbRef.value) {
          const scrollPos = rootContext.viewport.value.scrollTop;
          const offset2 = getThumbOffsetFromScroll(scrollPos, sizes.value);
          thumbRef.value.style.transform = `translate3d(0, ${offset2}px, 0)`;
        }
      }
    }
    ...
    return (_ctx, _cache) => {
      return isShowingScrollbarX.value ? (openBlock(), createBlock(_sfc_main270, mergeProps({ key: 0 }, _ctx.$attrs, { ref: unref(forwardRef) }), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
      }, 16)) : (openBlock(), createBlock(_sfc_main271, mergeProps({ key: 1 }, _ctx.$attrs, { ref: unref(forwardRef) }), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main273, mergeProps(_ctx.$attrs, {
            ref: unref(forwardRef),
            "data-state": visible.value ? "visible" : "hidden"
          }), {
            default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main272, mergeProps(_ctx.$attrs, { ref: unref(forwardRef) }), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main276 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(rootContext).type.value === "hover" ? (openBlock(), createBlock(_sfc_main274, mergeProps({ key: 0 }, _ctx.$attrs, {
        ref: unref(forwardRef),
        ...
        _: 3
      }, 16, ["force-mount"])) : unref(rootContext).type.value === "scroll" ? (openBlock(), createBlock(_sfc_main275, mergeProps({ key: 1 }, _ctx.$attrs, {
        ref: unref(forwardRef),
        "force-mount": unref(forceMount)
      }), {
        default: withCtx(() => [
        ...
        _: 3
      }, 16, ["force-mount"])) : unref(rootContext).type.value === "auto" ? (openBlock(), createBlock(_sfc_main273, mergeProps({ key: 2 }, _ctx.$attrs, {
        ref: unref(forwardRef),
        "force-mount": unref(forceMount)
      }), {
        default: withCtx(() => [
        ...
        _: 3
      }, 16, ["force-mount"])) : unref(rootContext).type.value === "always" ? (openBlock(), createBlock(_sfc_main272, mergeProps({ key: 3 }, _ctx.$attrs, {
        ref: unref(forwardRef),
        "data-state": "visible"
      }), {
        default: withCtx(() => [
    ...
    function position() {
      if (rootContext.triggerElement.value && rootContext.valueElement.value && contentWrapperElement.value && contentElement.value && (viewport == null ? void 0 : viewport.value) && (selectedItem == null ? void 0 : selectedItem.value) && (selectedItemText == null ? void 0 : selectedItemText.value)) {
        ...
        if (rootContext.dir.value !== "rtl") {
          ...
          const clampedLeft = clamp2(left, CONTENT_MARGIN, Math.max(CONTENT_MARGIN, rightEdge - contentWidth));
...
var _sfc_main282 = defineComponent({
  ...
  setup(__props) {
    ...
    const forwarded = useForwardProps(props2);
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main61), mergeProps(unref(forwarded), { style: {
        // Ensure border-box for floating-ui calculations
        "boxSizing": "border-box",
...
var _sfc_main284 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(rootContext).open.value && unref(contentContext).position === "popper" ? (openBlock(), createBlock(unref(_sfc_main62), normalizeProps(mergeProps({ key: 0 }, props2)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
var _sfc_main286 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      var _a;
      return present.value || renderPresence.value || ((_a = presenceRef.value) == null ? void 0 : _a.present) ? (openBlock(), createBlock(unref(Presence), {
        key: 0,
        ref_key: "presenceRef",
        ref: presenceRef,
        ...
        default: withCtx(() => [
          createVNode(_sfc_main283, normalizeProps(guardReactiveProps({ ...unref(forwarded), ..._ctx.$attrs })), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
        ...
        _: 3
      }, 8, ["present"])) : fragment.value ? (openBlock(), createElementBlock("div", _hoisted_16, [
        (openBlock(), createBlock(Teleport, { to: fragment.value }, [
          createVNode(_sfc_main285, { context: unref(rootContext) }, {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function handlePointerMove2(event) {
      ...
      if (disabled.value) {
        ...
        (_b = event.currentTarget) == null ? void 0 : _b.focus({ preventScroll: true });
      }
    }
    async function handlePointerLeave(event) {
      var _a;
...
var _sfc_main295 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return canScrollDown.value ? (openBlock(), createBlock(_sfc_main294, {
        key: 0,
        ref: unref(forwardRef),
...
var _sfc_main296 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return canScrollUp.value ? (openBlock(), createBlock(_sfc_main294, {
        key: 0,
        ref: unref(forwardRef),
        onAutoScroll: _cache[0] || (_cache[0] = () => {
          const { viewport, selectedItem } = unref(contentContext);
...
var _sfc_main304 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props2 = __props;
    const emits = __emit;
    const { max, min, dir, inverted } = toRefs(props2);
...
var _sfc_main305 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props2 = __props;
    const emits = __emit;
    const { max, min, inverted } = toRefs(props2);
    const rootContext = injectSliderRootContext();
    const { forwardRef, currentElement: sliderElement } = useForwardExpose();
    const offsetPosition = ref();
    const rectRef = ref();
...
var _sfc_main306 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props2 = __props;
    const emits = __emit;
    const { min, max, step, minStepsBetweenThumbs, orientation, disabled, thumbAlignment, dir: propDir } = toRefs(props2);
    const dir = useDirection(propDir);
    const { forwardRef, currentElement } = useForwardExpose();
    const isFormControl = useFormControl(currentElement);
    ...
    function updateValues(value, atIndex, { commit } = { commit: false }) {
      ...
      const nextValue = clamp2(snapToStep, min.value, max.value);
...
var _sfc_main308 = defineComponent({
  ...
  setup(__props) {
    ...
    const size2 = useSize(thumbElement);
...
var _sfc_main309 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main308, mergeProps({ ref: unref(forwardRef) }, props2, { index: index.value }), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
function resizePanel({
  ...
  size2 = Number.parseFloat(size2.toFixed(PRECISION));
  return size2;
}
...
function validatePanelGroupLayout({
  ...
  if (nextLayout.length !== panelConstraints.length) {
    throw new Error(
      `Invalid ${panelConstraints.length} panel layout: ${nextLayout.map((size2) => `${size2}%`).join(", ")}`
    );
  } else if (!fuzzyNumbersEqual(nextLayoutTotalSize, 100)) {
    {
      console.warn(
        `WARNING: Invalid layout total size: ${nextLayout.map((size2) => `${size2}%`).join(", ")}. Layout normalization will be applied.`
      );
    }
        ...
        switch (event.key) {
          case "Enter": {
            ...
            if (index >= 0) {
              ...
              assert(panelData);
              const size2 = layout.value[index];
              const {
                collapsedSize = 0,
                collapsible,
                minSize = 0
...
var _sfc_main312 = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function resize(size2) {
      resizePanel2(panelDataRef.value, size2);
    }
    __expose({
...
var _sfc_main328 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props2 = __props;
    const emits = __emit;
    const { addOnPaste, disabled, delimiter, max, id, dir: propDir, addOnBlur, addOnTab } = toRefs(props2);
    const dir = useDirection(propDir);
    const modelValue = useVModel(props2, "modelValue", emits, {
      defaultValue: props2.defaultValue,
      passive: true,
...
var _sfc_main339 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        announceTextContent.value ? (openBlock(), createBlock(_sfc_main338, {
          key: 0,
          role: "alert",
...
var _sfc_main340 = defineComponent({
  ...
  setup(__props) {
    ...
    const { forwardRef } = useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main336, { "as-child": "" }, {
        default: withCtx(() => [
...
var _sfc_main341 = defineComponent({
  ...
  setup(__props) {
    ...
    const { forwardRef } = useForwardExpose();
    return (_ctx, _cache) => {
      return _ctx.altText ? (openBlock(), createBlock(_sfc_main336, {
        key: 0,
        "alt-text": _ctx.altText,
        "as-child": ""
      }, {
        default: withCtx(() => [
          createVNode(_sfc_main340, {
            ref: unref(forwardRef),
            as: _ctx.as,
            "as-child": _ctx.asChild
          }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main339, mergeProps({
            ref: unref(forwardRef),
            open: unref(open),
            type: _ctx.type,
            as: _ctx.as,
...
var _sfc_main348 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main347), {
        role: "region",
        ...
        default: withCtx(() => [
          hasToasts.value ? (openBlock(), createBlock(_sfc_main346, {
            key: 0,
            ref: (node) => {
...
var _sfc_main357 = defineComponent({
  ...
  setup(__props) {
    ...
    const { forwardRef } = useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main352, { "as-child": "" }, {
        default: withCtx(() => [
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main15), {
        ...
        default: withCtx(() => [
          createVNode(unref(_sfc_main61), mergeProps({
            ref: unref(forwardRef),
      ...
      if (item.parentItem != null && Array.isArray(modelValue.value) && props2.multiple) {
        ...
        if (parentItem != null) {
          ...
          if (areAllChilredOfParentSelected) {
            ...
            modelValue.value = modelValue.value.filter((v) => props2.getKey(v) !== props2.getKey(parentItem.value));
          }
