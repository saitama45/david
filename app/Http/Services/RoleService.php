        ...
        $permissionStructure = [
            'Administration' => [
                ...
                'Templates' => [
                    ...
                    'view month end count templates', 'create month end count templates', 'edit month end count templates', 'delete month end count templates', 'export month end count templates', 'import month end count templates',
                ],
                'Schedules' => [
