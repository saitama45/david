...
const calculateGSIOrderDate = () => {
    ...
    console.log(secondBatchEndDate);
    console.log(secondBatchStartDate);
...
if (now.getHours() >= 7) {
    orderRestrictionDate.minDate = tomorrow;
    orderRestrictionDate.maxDate = tomorrow;
} else {
    orderRestrictionDate.minDate = now;
    orderRestrictionDate.maxDate = now;
}
...
<template>
    <Layout
        heading="Additional Store Order > Create"
        :hasButton="true"
