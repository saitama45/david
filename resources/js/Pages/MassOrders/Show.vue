                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        >
                            ...
                            <TD class="text-center font-mono">{{ String(history.display_status || '').toUpperCase().trim() === 'TO COMMIT' ? 0 : formatQuantity(history.committed_display) }}</TD>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div class="text-center">
                                ...
                                <span class="font-bold text-lg text-gray-900">{{ String(selectedItem.display_status || '').toUpperCase().trim() === 'TO COMMIT' ? 0 : formatQuantity(selectedItem.committed_display) }}</span>
                            </div>
                            <div class="text-center">
